...
func RPCConnect(c conf.RPCConf, o conf.OpenIDConfig, txTimeout int) (RPCClient, identity.IdentityClient, error) {
	...
	identityClient, err := newIdentityClient(o, configProvider, userStore)
